...
This repository contains the code and documentation for the NeighborMart Customer Segmentation Project. The full report and detailed documentation can be found on .
# Dataset
...
 Tracking key factors like admission type, length of stay, and medication count will helps clinicians identify high-risk patients early.
